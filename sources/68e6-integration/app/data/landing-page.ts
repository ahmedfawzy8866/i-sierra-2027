...
export const COPY = {
  en: {
    ...
    stats: [['1,200+', 'Portfolio Assets'], ['98%', 'Match Rate'], ['8+', 'Compounds'], ['4s', 'Response Time']] as [string, string][],
    scroll: 'Scroll',
  ...
  ar: {
    ...
    stats: [['١٢٠٠+', 'أصول المحفظة'], ['٩٨٪', 'نسبة المطابقة'], ['٨+', 'كمباوند'], ['٤ث', 'زمن الرد']] as [string, string][],
    scroll: 'اسحب',
