/**
 * sierra estates — PDF EXPORT SERVICE
  ...
  private static buildProposalHTML(data: ProposalPDFData): string {
    return `
      ...
      <body>
        ...
        <div class="footer">
          <p>This proposal was generated by Sierra Estates's AI Intelligence Engine on ${new Date().toLocaleDateString()}</p>
  ...
  private static buildPropertyReportHTML(analysis: any): string {
    return `
      ...
      <body>
        ...
        <div class="footer">
          <p>Generated by Sierra Estates Intelligence Engine on ${new Date().toLocaleDateString()}</p>
        </div>
      </body>
      </html>
    `;
