/**
 * Sierra AI — ASSET ENCODING SERVICE
...
/**
 * Parses raw copied listing information into the Sierra AI Unit schema.
 * Uses the "Sierra Codification Protocol."
 */
export async function encodeListingFromText(rawText: string): Promise<Partial<Unit>> {
  const systemPrompt = `ROLE: You are "Sierra," the Lead Logic Agent for Asset Registration at Sierra AI.
