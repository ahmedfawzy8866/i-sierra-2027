...
class UserInputManager {
    ...
    async promptForHost(options) {
        ...
        const refreshList = () => {
            const items = this.createHostQuickPickList(this.deviceManager.getAllDevices(), this.deviceManager.lastUsedDevice, itemCache);
            ...
            if (VscodeContextManager_1.vscodeContextManager.get('brightscript.deviceDiscovery.enabled') !== true) {
                buttons.unshift({
    ...
    getDeviceIcon(device) {
        ...
        return icons_1.icons.getDeviceType(device);
    }
     ...
     */
    createHostQuickPickList(devices, lastUsedDevice, cache = new Map()) {
        var _a;
        ...
        lastUsedDevice = (_a = devices.find(x => x.serialNumber === (lastUsedDevice === null || lastUsedDevice === void 0 ? void 0 : lastUsedDevice.serialNumber))) !== null && _a !== void 0 ? _a : lastUsedDevice;
        //remove the lastUsedDevice from the devices list so we can more easily reason with the rest of the list
        devices = devices.filter(x => x.serialNumber !== (lastUsedDevice === null || lastUsedDevice === void 0 ? void 0 : lastUsedDevice.serialNumber));
