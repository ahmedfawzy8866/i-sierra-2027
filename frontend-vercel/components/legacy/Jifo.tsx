 ...
 * Persona: Leila (Warm Levant tone).
 */
    ...
    <div className="min-h-screen bg-[#F4F0E8] flex flex-col font-inter">
      ...
      <nav className="h-20 border-b border-[#C9A84C]/10 flex items-center justify-between px-6 md:px-12 bg-white/50 backdrop-blur-md sticky top-0 z-50">
        <div className="flex flex-col">
          <span className="text-[10px] uppercase tracking-[0.3em] text-[#0A1628]/40 font-bold">Sierra AI Realty</span>
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  <div className="flex-1">
                    ...
                    <div className="mt-4 flex items-center gap-2">
                      ...
                      <span className="text-[10px] uppercase tracking-widest text-[#C9A84C] font-bold">Leila, Senior Concierge</span>
                    </div>
                  </div>
                  <button 
          ...
          <div className="lg:col-span-7 w-full relative">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="relative aspect-[4/5] md:aspect-square bg-[#0A1628] rounded-sm overflow-hidden shadow-2xl"
              >
                ...
                <div className="lg:col-span-5 flex flex-col justify-between">
                  ...
                  <div className="space-y-6">
                    ...
                    >
                      <EditorialHeading level={2} className="text-3xl md:text-4xl mb-2 font-playfair">
                        {currentUnit.title}
                      </EditorialHeading>
                    ...
                    <motion.div 
                      ...
                      className="py-6 border-t border-b border-[#0A1628]/10"
                    >
                      <p className="text-sm uppercase tracking-wider text-[#0A1628]/60 mb-2">Investment Value</p>
                      <div className="flex items-baseline gap-2">
                        <span className="text-5xl font-bold text-[#0A1628]">
                          {(currentUnit.price / 1_000_000).toFixed(1)}M
                        </span>
                        <span className="text-xl text-[#0A1628]/60">EGP</span>
                      </div>
                    </motion.div>
                    ...
                    >
                      <div className="p-4 bg-[#C9A84C]/5 border border-[#C9A84C]/20 rounded-lg">
                        <p className="text-xs uppercase tracking-widest text-[#0A1628]/60 mb-2">Annual Yield</p>
                        <p className="text-2xl font-bold text-[#C9A84C]">
                          {currentUnit.estimatedYield.toFixed(1)}%
                        </p>
                      </div>
                      <div className="p-4 bg-[#C9A84C]/5 border border-[#C9A84C]/20 rounded-lg">
                        <p className="text-xs uppercase tracking-widest text-[#0A1628]/60 mb-2">Est. ROI (36mo)</p>
                        <p className="text-2xl font-bold text-[#C9A84C]">
                    ...
                    <motion.p 
                      ...
                      className="text-[#0A1628]/70 leading-relaxed font-light text-base italic"
                    >
                  ...
                  <motion.div 
                    ...
                    className="grid grid-cols-2 gap-4 pt-8 mt-8 border-t border-[#0A1628]/10"
                  >
                    <GoldButton 
                    ...
                    <button 
                      ...
                      className="px-4 py-3 border-2 border-[#0A1628]/30 text-[#0A1628] font-semibold rounded-lg hover:bg-[#0A1628]/5 transition-all uppercase text-xs tracking-wider"
                    >
                      <Share2 size={16} className="inline mr-2" />
                      Share
                    </button>
                    <button className="px-4 py-3 border-2 border-[#0A1628]/30 text-[#0A1628] font-semibold rounded-lg hover:bg-[#0A1628]/5 transition-all uppercase text-xs tracking-wider">
      ...
      <footer className="py-12 px-6 border-t border-[#C9A84C]/10 bg-white/30 text-center">
        ...
        <p className="text-[11px] text-[#0A1628]/50 max-w-lg mx-auto leading-relaxed italic">
          This portfolio is curated exclusively for {portfolio.leadName}. All projections are based on current market trends and historical performance by Sierra AI Realty.
        </p>
      </footer>
    </div>
  );
