...
exports.ContextSwitcherProvider = void 0;
const vscode = __importStar(require("vscode"));
class ContextSwitcherProvider {
    constructor(_extensionUri, contextSwitcher) {
    ...
    async createBookmark(title, description) {
        ...
        await this.contextSwitcher.createBookmark(title, description, editor.document.uri.fsPath, editor.selection.start);
...
exports.ContextSwitcherProvider = ContextSwitcherProvider;
ContextSwitcherProvider.viewType = 'autoboot.contextSwitcher';
