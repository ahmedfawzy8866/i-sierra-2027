(()=>{var J={6820:(e,c,n)=>{"use strict";n.r(c),n.d(c,{default:()=>j});var s=n(6758),d=n.n(s),f=n(935),_=n.n(f),y=n(4997),x=n(7681),C=n.n(x),A=new URL(n(1821),n.b),T=new URL(n(6949),n.b),N=_()(d());N.i(y.A);var u=C()(A),O=C()(T);N.push([e.id,`/* Base styling sheet for standard tags and common classes */
...
`,""]);const j=N},4997:(e,c,n)=>{"use strict";n.d(c,{A:()=>N});var s=n(6758),d=n.n(s),f=n(935),_=n.n(f),y=n(7681),x=n.n(y),C=new URL(n(7336),n.b),A=_()(d()),T=x()(C);A.push([e.id,`/* 
