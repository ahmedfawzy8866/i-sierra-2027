...
let DOCUMENT_ELEMENT_SELECTORS = {
  ...
  send_message_btn: ["span[data-icon=\"send\"]",
        ...
        "[data-icon=\"send\"]",
        "button[tabindex=\"0\"] > span[data-icon=\"send\"]",
...
let HELP_MESSAGES = {
  REQUEST_CHAT_SUPPORT_BASIC:
    "Hi, I would like to request chat support for Smart WA Sender Pro Basic.",
  REQUEST_CHAT_SUPPORT_ADVANCE:
    "Hi, I would like to request chat support for Smart WA Sender Pro Advance.",
  REQUEST_ZOOM_SUPPORT_BASIC:
    "Hi, I would like to request video call support for Smart WA Sender Pro Basic.",
  REQUEST_ZOOM_SUPPORT_ADVANCE:
    "Hi, I would like to request video call support for Smart WA Sender Pro Advance.",
  REQUEST_CALL_SUPPORT_ADVANCE:
    "Hi, I would like to request call support for Smart WA Sender Pro Advance.",
  REQUEST_CALL_SUPPORT_BASIC:
    "Hi, I would like to request call support for Smart WA Sender Pro Basic.",
  ...
  NEED_HELP_NON_PREMIUM: "Hi, I need help in using Smart WA Sender Pro.",
};
...
let FAQS = [
  ...
  {
    question: "How to send clickable links through Smart WA Sender Pro?",
    answer:
