...
class LanguageServerManager {
    ...
    async getBsdkVersionInfo() {
        ...
        if (this.workspaceConfigIncludesBsdkKey()) {
            let result = this.parseVersionInfo((_b = (_a = util_1.util.getConfiguration('brightscript', vscode.workspace.workspaceFile).get('bsdk')) === null || _a === void 0 ? void 0 : _a.trim) === null || _b === void 0 ? void 0 : _b.call(_a), path.dirname(vscode.workspace.workspaceFile.fsPath));
            if (result) {
                return result.value;
            }
        }
        ...
        const folderResults = (_d = (_c = vscode.workspace.workspaceFolders) === null || _c === void 0 ? void 0 : _c.reduce((acc, workspaceFolder) => {
            const versionInfo = util_1.util.getConfiguration('brightscript', workspaceFolder).get('bsdk');
    ...
    async deleteOutdatedBscVersions() {
        var _a, _b, _c;
        const npmCacheRetentionDays = (_c = (_b = (_a = util_1.util.getConfiguration('brightscript')) === null || _a === void 0 ? void 0 : _a.get) === null || _b === void 0 ? void 0 : _b.call(_a, 'npmCacheRetentionDays', 45)) !== null && _c !== void 0 ? _c : 45;
