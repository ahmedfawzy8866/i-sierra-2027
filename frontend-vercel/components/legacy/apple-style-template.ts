...
export class AppleHIGWebviewTemplate {
     ...
     */
    static generateAppleStyleWebview(title: string, content: string, styles: string = ''): string {
     ...
     */
    private static generateHeadContent(title: string): string {
        return `
    <meta charset="UTF-8">
     ...
     */
    private static generateBodyContent(content: string, customStyles: string): string {
        return `
     ...
     */
    private static wrapHtmlDocument(head: string, body: string): string {
        return `
<!DOCTYPE html>
<html lang="en">
<head>${head}</head>
<body>${body}</body>
     ...
     */
    private static getAppleStyles(): string {
        return `
        :root {
            --apple-blue: #007AFF;
            --apple-purple: #5856D6;
     ...
     */
    private static getAppleScripts(): string {
        return `
     ...
     */
    static generateStatusCard(title: string, status: 'running' | 'stopped' | 'loading', details: string): string {
     ...
     */
    private static getStatusConfig(status: 'running' | 'stopped' | 'loading') {
        const configs = {
     ...
     */
    private static buildStatusCard(title: string, config: any, details: string): string {
        return `
            <div class="card">
     ...
     */
    static generateFeatureList(features: Array<{title: string, description: string, icon: string, status?: string}>): string {
     ...
     */
    private static buildFeatureItem(feature: {title: string, description: string, icon: string, status?: string}): string {
