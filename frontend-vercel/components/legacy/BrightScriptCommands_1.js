...
class BrightScriptCommands {
    ...
    registerGeneralCommands() {
        ...
        this.registerCommand('enableDeviceDiscovery', async () => {
            await util_1.util.setConfigurationValueAtUserOrClosestScope('brightscript.deviceDiscovery.enabled', true);
        });
        this.registerCommand('disableDeviceDiscovery', async () => {
            await util_1.util.setConfigurationValueAtUserOrClosestScope('brightscript.deviceDiscovery.enabled', false);
        });
        ...
        this.registerCommand('setActiveDevice', async (deviceOrItem) => {
            ...
            if (typeof deviceOrItem === 'object' && (deviceOrItem === null || deviceOrItem === void 0 ? void 0 : deviceOrItem.key)) {
                ip = (_a = this.deviceManager.getDevice(deviceOrItem.key)) === null || _a === void 0 ? void 0 : _a.ip;
            }
        ...
        this.registerCommand('editDeviceInUserSettings', async (deviceOrItem) => {
            const device = this.deviceManager.getDevice(deviceOrItem === null || deviceOrItem === void 0 ? void 0 : deviceOrItem.key);
            await this.openSettingsJsonAtDevice(device, 'user');
        });
        this.registerCommand('editDeviceInWorkspaceSettings', async (deviceOrItem) => {
            const device = this.deviceManager.getDevice(deviceOrItem === null || deviceOrItem === void 0 ? void 0 : deviceOrItem.key);
            await this.openSettingsJsonAtDevice(device, 'workspace');
        });
        this.registerCommand('addDeviceToUserSettings', async (deviceOrItem) => {
            const device = this.deviceManager.getDevice(deviceOrItem === null || deviceOrItem === void 0 ? void 0 : deviceOrItem.key);
            if (!device) {
            ...
            const userDevices = (inspection === null || inspection === void 0 ? void 0 : inspection.globalValue) || [];
        ...
        this.registerCommand('addDeviceToWorkspaceSettings', async (deviceOrItem) => {
            const device = this.deviceManager.getDevice(deviceOrItem === null || deviceOrItem === void 0 ? void 0 : deviceOrItem.key);
            if (!device) {
                void vscode.window.showErrorMessage('Could not find device to add to settings.');
                return;
            ...
            const config = vscode.workspace.getConfiguration('brightscript');
            const inspection = config.inspect('devices');
            const workspaceDevices = (inspection === null || inspection === void 0 ? void 0 : inspection.workspaceValue) || [];
    ...
    async getRemoteHost(showPrompt = true) {
        ...
        if (!this.host) {
            let config = util_1.util.getConfiguration('brightscript.remoteControl');
     ...
     */
    async openSettingsJsonAtDevice(device, scope) {
