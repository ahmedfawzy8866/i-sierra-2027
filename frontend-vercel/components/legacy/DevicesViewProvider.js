        ...
        if (!element) {
            ...
            if (this.devices) {
                ...
                for (const device of this.devices) {
                    ...
                    let treeItem = new DeviceTreeItem(this.makeName(device), vscode.TreeItemCollapsibleState.Collapsed, device.serialNumber, device.deviceInfo);
                    ...
                    if (device.deviceState === 'offline') {
                        ...
                        treeItem.iconPath = icons_1.icons.getDeviceType(device);
                    }
            ...
            for (let [key, values] of details) {
                result.push(this.createDeviceInfoTreeItem({
                    ...
                    description: (_a = values.value) === null || _a === void 0 ? void 0 : _a.toString(),
