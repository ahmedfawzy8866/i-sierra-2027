...
export const collections = {
   ...
   */
  subscribeToStats(callback: (stats: any) => void): Unsubscribe {
    // For real-time stats, we need to subscribe to leads and compute
    return this.subscribeToLeads(async (leads) => {
