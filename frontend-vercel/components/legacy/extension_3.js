...
class Extension {
    ...
    async activate(context) {
        ...
        context.subscriptions.push(vscode.languages.registerDocumentLinkProvider({ language: 'Log' }, docLinkProvider));
    ...
    async debugSessionCustomEventHandler(e, context, docLinkProvider, logOutputManager, rendezvousViewProvider) {
        ...
        if ((0, roku_debug_1.isLaunchStartEvent)(e)) {
            ...
            const diagnostics = (_c = (_b = e.body) === null || _b === void 0 ? void 0 : _b.diagnostics) !== null && _c !== void 0 ? _c : [];
    ...
    writeExtensionLog(text) {
        var _a, _b;
        let extensionLogfilePath = vscode.workspace.getConfiguration('brightscript').get('extensionLogfilePath');
