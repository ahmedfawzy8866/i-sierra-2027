...
const SystemDashboard = dynamic(() => import('../System/SystemDashboard'), { ssr: false });

type AdminScreen = 'dashboard' | 'team-crm' | 'listings' | 'nexus' | 'intelligence' | 'media' | 'database' | 'system';
