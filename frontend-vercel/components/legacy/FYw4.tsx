      ...
      <header className="mb-8 flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-light tracking-wide flex items-center gap-3">
            ...
            OUTSIDER SYSTEM <span className="text-sm px-2 py-1 bg-white/10 rounded-full text-white/70 ml-2">v12.0</span>
          </h1>
      ...
      >
        ...
        {activeTab === 'orchestrator' && (
          <div className="p-6 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md">
            ...
            <div className="flex flex-col space-y-6 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white/20 before:to-transparent">
               ...
               <PipelineStage num="3" title="Branded Asset Generation" desc="Applied Sierra AI Standard gradient and logo." active />
