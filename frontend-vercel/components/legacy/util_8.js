...
class Util {
    ...
    getConfiguration(section, resource) {
        return vscode.workspace.getConfiguration(section, resource !== null && resource !== void 0 ? resource : null);
    }
     ...
     */
    async setConfigurationValueAtUserOrClosestScope(key, value) {
        var _a, _b, _c, _d, _e;
        ...
        const scope = (_c = (_b = (_a = vscode.workspace.workspaceFolders) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.uri) !== null && _c !== void 0 ? _c : vscode.workspace.workspaceFile;
        const inspection = vscode.workspace.getConfiguration(configurationKey, scope).inspect(settingKey);
        let target;
        let resource;
        if (!vscode.workspace.workspaceFile && (inspection === null || inspection === void 0 ? void 0 : inspection.workspaceFolderValue) !== undefined) {
            // Single-folder: write to .vscode/settings.json
            target = vscode.ConfigurationTarget.WorkspaceFolder;
            resource = (_e = (_d = vscode.workspace.workspaceFolders) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.uri;
        }
        else if ((inspection === null || inspection === void 0 ? void 0 : inspection.workspaceValue) !== undefined) {
