/**
 * Sierra AI — MATCHING ENGINE VALIDATION SUITE
...
const TEST_UNITS: Partial<Unit>[] = [
  ...
  },
  {
    ...
    status: 'available',
    price: 4_200_000,
    intelligence: { roi: 9.5, yield: 6.1 }
  },
  // Sodic Units
  {
    ...
    status: 'available',
    price: 8_900_000,
    intelligence: { roi: 11.2, yield: 5.8 }
  },
  {
    ...
    status: 'available',
    price: 6_200_000,
    intelligence: { roi: 10.5, yield: 6.2 }
  },
  // New Cairo Units
  {
    ...
    status: 'available',
    price: 2_100_000,
    intelligence: { roi: 8.5, yield: 7.3 }
  },
  {
    ...
    status: 'available',
    price: 3_500_000,
    intelligence: { roi: 9.2, yield: 7.1 }
  },
  // Palm Hills Units
  {
    ...
    status: 'available',
    price: 18_500_000,
    intelligence: { roi: 12.5, yield: 4.9 }
  },
  {
    ...
    status: 'available',
    price: 11_200_000,
    intelligence: { roi: 11.8, yield: 5.2 }
  },
  // Zed Units
  {
    ...
    status: 'available',
    price: 9_800_000,
    intelligence: { roi: 10.3, yield: 5.5 }
  },
  {
    ...
    status: 'available',
    price: 5_600_000,
    intelligence: { roi: 9.8, yield: 6.4 }
  },
];
...
export async function runMatchingValidationSuite() {
  console.log('🧪 Sierra AI MATCHING ENGINE VALIDATION\n');
  ...
  try {
    ...
    for (const unit of TEST_UNITS.slice(0, 10)) {
      const docRef = await addDoc(collection(db, 'units'), {
        ...unit,
        status: 'available',
        sbr_code: generateSBRCode(unit.compound, unit.rooms),
        createdAt: new Date(),
      });
