...
exports.UserInputManager = exports.scanForDevicesItemId = exports.manualHostItemId = void 0;
...
class UserInputManager {
    ...
    async promptForHost(options) {
        ...
        if (options === null || options === void 0 ? void 0 : options.defaultValue) {
            quickPick.value = options === null || options === void 0 ? void 0 : options.defaultValue;
        }
        quickPick.show();
        ...
        const refreshList = () => {
            const items = this.createHostQuickPickList(this.deviceManager.getAllDevices(), this.deviceManager.getLastUsedDeviceIp(), itemCache);
            quickPick.items = items;
            const discoveryEnabled = VscodeContextManager_1.vscodeContextManager.get('brightscript.deviceDiscovery.enabled') === true;
            ...
            quickPick.buttons = [
                {
                    iconPath: discoveryEnabled ? icons_1.icons.radioTower : icons_1.icons.radioTowerOff,
        ...
        quickPick.onDidTriggerButton(button => {
            if (button.tooltip === SCAN_FOR_DEVICES) {
                ...
                void util_1.util.setConfigurationValueAtUserOrClosestScope('brightscript.deviceDiscovery.enabled', true);
            }
            else if (button.tooltip === DISABLE_DEVICE_DISCOVERY) {
                void util_1.util.setConfigurationValueAtUserOrClosestScope('brightscript.deviceDiscovery.enabled', false);
            }
        });
        ...
        dispose();
        if ((result === null || result === void 0 ? void 0 : result.manual) === true) {
            return this.promptForHostManual();
        }
        else {
            return result === null || result === void 0 ? void 0 : result.ip;
        }
    }
    /**
    ...
    getDeviceIcon(device) {
        ...
        return icons_1.icons.getDeviceType(device.deviceInfo);
    }
    createHostLabel(device) {
        return [
     ...
     */
    createHostQuickPickList(devices, lastUsedDeviceIp, cache = new Map()) {
        ...
        items.push({
            label: manualLabel,
            device: { id: exports.manualHostItemId },
            iconPath: new vscode.ThemeIcon('keyboard')
        }, {
            label: scanForDevicesLabel,
            device: { id: exports.scanForDevicesItemId },
