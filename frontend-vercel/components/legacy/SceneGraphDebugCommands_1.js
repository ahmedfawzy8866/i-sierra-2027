...
exports.sceneGraphDebugCommands = exports.SceneGraphDebugCommands = void 0;
const vscode = require("vscode");
const roku_debug_1 = require("roku-debug");
const util_1 = require("./util");
class SceneGraphDebugCommands {
    registerCommands(context, outputChannel) {
        ...
        subscriptions.push(vscode.commands.registerCommand('extension.brightscript.fpsDisplay', async () => {
            ...
            if (option) {
                await this.logCommandOutput(async (commandController) => commandController.fpsDisplay(option));
            }
        }));
        ...
        subscriptions.push(vscode.commands.registerCommand('extension.brightscript.logrendezvous', async () => {
            ...
            if (option) {
                await this.logCommandOutput(async (commandController) => commandController.logrendezvous(option));
            }
        }));
        ...
        subscriptions.push(vscode.commands.registerCommand('extension.brightscript.brightscriptWarnings', async () => {
            let limit = parseInt(await vscode.window.showInputBox({ placeHolder: '100', validateInput: (value) => {
    ...
    async logCommandOutput(callback) {
        var _a, _b;
        await this.getRemoteHost();
        let response = await callback(new roku_debug_1.SceneGraphDebugCommandController(this.host));
        ...
        let lines = ((_b = (_a = response === null || response === void 0 ? void 0 : response.error) === null || _a === void 0 ? void 0 : _a.message) !== null && _b !== void 0 ? _b : response.result.rawResponse).split('\n');
...
exports.SceneGraphDebugCommands = SceneGraphDebugCommands;
exports.sceneGraphDebugCommands = new SceneGraphDebugCommands();
//# sourceMappingURL=SceneGraphDebugCommands.js.map