    ...
    <div className="dashboard-container">
      <aside className="sidebar">
        <div className="brand-block">
          <span className="brand-name">Sierra AI</span>
          <span className="brand-role">
            <Lock size={10} />
            {currentUser.role === 'super_admin' ? 'Intelligence OS' : 'Agent Portal'}
          </span>
        </div>
        ...
        <div className="sidebar-footer">
          ...
          <button onClick={toggleUser} className="btn" style={{ width: '100%', justifyContent: 'center' }}>
            <RefreshCw size={15} /> Swap Identity
          </button>
        </div>
      </aside>
      ...
      <main className="main-content">
        ...
        <div className="content-viewport">
          {activeTab === 'overview' && (
            <div className="overview-page animate-fade-in">
              ...
              <p className="overview-sub">
                Welcome to the Sierra AI Strategic Dashboard. All 10 stages of the Intelligence Pipeline are operational.
              </p>
          ...
          {activeTab === 'easylisting' && <EasyListingModule currentUserRole={currentUser.role} currentUserId={currentUser.id} />}
          {activeTab === 'crm'        && <CRMModule currentUserRole={currentUser.role} currentUserId={currentUser.id} />}
