/**
 * Sierra AI — VECTOR INTELLIGENCE SERVICE
 * Bridge to Gemini text-embedding-004 for Semantic Memory.
 */

import { GoogleGenerativeAI } from "@google/generative-ai";

const API_KEY = process.env.GOOGLE_AI_API_KEY || process.env.GOOGLE_GENAI_API_KEY || "";
const genAI = new GoogleGenerativeAI(API_KEY);

/**
 * Generates a 768-dimensional vector embedding for the provided text.
 * Optimized for Sierra AI's real estate and stakeholder datasets.
 */
 ...
 */
export function createSemanticString(data: Record<string, string | number | boolean | null | undefined>): string {
  // Sierra AI PropTech Contextualization
