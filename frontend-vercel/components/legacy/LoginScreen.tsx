...
export default function LoginScreen({ onBack }: { onBack?: () => void }) {
  ...
  const showSupportMessage = () => {
    setError('Contact the Sierra AI admin team to reset or provision access.');
  };
      ...
      <div style={{ 
        ...
        >
          <div style={{ marginBottom: '40px' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '15px', letterSpacing: '0.3px' }}>Authentication Required for Sierra AI Advisors</p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ fontSize: '12px', color: 'var(--text-secondary)', lineHeight: '1.4' }}>
              Systems secured by <span style={{ fontWeight: 600, color: 'var(--text-primary)' }}>Sierra AI CyberOps</span>. 
