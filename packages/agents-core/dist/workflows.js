export class AgentWorkflows {
    ...
    async runApiWorkflow(taskDescription) {
        return this.orchestrator.orchestratePipeline('API Workflow', [
            {
    ...
    async runDebugWorkflow(taskDescription) {
        return this.orchestrator.orchestratePipeline('Debug Workflow', [
            {
    ...
    async runPlanWorkflow(taskDescription) {
        return this.orchestrator.orchestratePipeline('Plan Workflow', [
            {
    ...
    async runSecurityWorkflow(taskDescription) {
        return this.orchestrator.orchestratePipeline('Security Workflow', [
            {
    ...
    async runAuditWorkflow(taskDescription) {
        return this.orchestrator.orchestratePipeline('Audit Workflow', [
            {
    ...
    async runUiUxWorkflow(taskDescription) {
        return this.orchestrator.orchestratePipeline('UI/UX Enhancement Workflow', [
            {
