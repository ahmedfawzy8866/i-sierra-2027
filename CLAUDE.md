...
## Stack
Next.js 16 (App Router, Turbopack) · React 19 · TypeScript 5 (strict) · Tailwind 4 · Firebase (client SDK 12 + Admin SDK 13: Firestore, Storage, Auth) · Leaflet maps · next-intl (en/ar) · **Docker n8n Workflow Engine** (`localhost:5678`). Deploy: Vercel (web app) + Firebase Hosting (admin portal) + Firebase Cloud Functions; Firestore/Storage rules pending deploy. Observability: OpenTelemetry + Arize.
